...
function msnryGalleryInit() {
  ...
  var scrollTicker, lightboxAttr, sidebar,
    ...
    screen = 'desktop',
    mobileInitW = mfn.mobileInit '.ui-tabs-nav').innerHeight() || 0;
  ...
  $(document).on('mfnPopupInit', function() {
    ...
    if( $('.mfn-popup-tmpl.mfn-popup-active .chart:not(.mfn-initialized)').length ){
      $('.mfn-popup-tmpl.mfn-popup-active .chart:not(.mfn-initialized)').each(function() {
          var lineW = simple "mfn-arrow-icon"><img src="'+that.attr('data-path')+'" alt=""></span>';
                  ...
                  $({
                    ...
                    step: function() {
                      if( thousands_separator ){
                        el.text(Math.floor(this.property).toString().replace(/\B(?=(\d{3})+(","))
                      } else {
  ...
  function mfnSliderClients() {
    $('.clients_slider_ul').each(function() {
      ...
      var calcScroll = calc;
      var slidesToScroll = slider.closest('.clients_slider').attr('data-slides-to-scroll') "button the-icon slider_prev" href="#"><span class="button_icon"><i class="icon-left-open-big" aria-label="previous slide"></i></span></a>',
        nextArrow: '<a class="button the-icon slider_next" href="#"><span class="button_icon"><i class="icon-right-open-big" aria-label="next slide"></i></span></a>',
        ...
        rtl: rtl ? true : false,
        autoplay: mfn.slider.portfolio '+i+'"></div>');
